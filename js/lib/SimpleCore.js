...
const SimpleCore = {
    ...
    readMode: 'day',
    initParams (params) {
        SimpleCore.rootUrl = params.resourceUrl || params.rootUrl || location.href;
    ...
    changeReadModel () {
        ...
        if (SimpleCore.getLocalData('read-mode') == 'night') {
            ...
            $(".cover-img").attr('src', `https://shuoit.net/images/cover-night.jpg`);
        } else {
            $('body').removeClass('night-mode');
            btn.find('i').attr('class', 'fa fa-sun-o');
            $(".cover-img").attr('src', `https://shuoit.net/images/cover-day.jpg`);
        }
    },
    alert (title,msg) {
